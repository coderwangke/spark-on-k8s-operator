...
require (
	...
	github.com/google/go-cloud v0.0.0-00010101000000-000000000000
	...
	volcano.sh/volcano v0.0.0-20200304003033-d6c1107ce374
)

replace (
	github.com/google/go-cloud => gocloud.dev v0.19.0
